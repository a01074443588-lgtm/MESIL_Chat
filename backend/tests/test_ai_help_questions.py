...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("어르0001의 최근 모습 알려줘", "record_search"),
        ("어르0001의 음용량은 어떻게 돼?", "record_search"),
        ("어르0001 오늘 출석했나요?", "record_search"),
        ("어르 0001 오늘 출석했나요?", "record_search"),
        ("어르0001의 내부 기록을 볼 수 있나요?", "record_search"),
