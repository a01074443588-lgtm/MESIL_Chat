...
> 이 문서의 1,142건은 9월 15일 이전 공개 기반 소스의 시험 범위입니다. 2026년 9월 18일 제출 기준본 A에는 실행 이미지 소스와 직접 관련 신규 시험을 반영했습니다. 아래 수치를 최신 패키지 전체 시험 통과 수로 해석하지 마세요. 최신 확인 범위는 `docs/RELEASE_BASELINE_20260918.md`에 기록합니다.
